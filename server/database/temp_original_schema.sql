...
COMMENT ON COLUMN gosalary.goinstlq IS 'Institution Lower Quartile salary (┬ú)';
COMMENT ON COLUMN gosalary.goinstmed IS 'Institution Median salary (┬ú)';
COMMENT ON COLUMN gosalary.goinstuq IS 'Institution Upper Quartile salary (┬ú)';
...
COMMENT ON COLUMN leo3.leo3instlq IS 'Institution Lower Quartile earnings (┬ú)';
COMMENT ON COLUMN leo3.leo3instmed IS 'Institution Median earnings (┬ú)';
COMMENT ON COLUMN leo3.leo3instuq IS 'Institution Upper Quartile earnings (┬ú)';
...
COMMENT ON COLUMN leo5.leo5instlq IS 'Institution Lower Quartile earnings (┬ú)';
COMMENT ON COLUMN leo5.leo5instmed IS 'Institution Median earnings (┬ú)';
COMMENT ON COLUMN leo5.leo5instuq IS 'Institution Upper Quartile earnings (┬ú)';
