...
CREATE TABLE tariff (
    ...
    taragg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE continuation (
    ...
    contagg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE common (
    ...
    comagg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE govoicework (
    ...
    goworkagg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE leo5 (
    ...
    leo5agg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE nss (
    ...
    nssagg VARCHAR(2),  -- Aggregation indicator
...
CREATE TABLE nsscountry (
    ...
    nsscountryagg VARCHAR(2),  -- Aggregation indicator
